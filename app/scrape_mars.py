...
def scrape_all():
    ...
    browser = Browser("chrome", executable_path="C:/Users/SujitS.JHBP/Resources/UCIRV201807DATA4-Class-Repository-DATA/01-Lesson-Plans/13-Web-Scraping-and-Document-Databases/2/Activities/07-Ins_Splinter/Solved/chromedriver", headless=True)
